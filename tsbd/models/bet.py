        ...
        if bet_kind =='exact_score':
            if mode=='bet':
                ...
                if r:
                    ...
                    bet_score1 = last_score1
                    bet_score2 = last_score2
            ...
            if bet_kind=='exact_score':
                if winning_ratio ==-1:
                    ...
                    if mode=='bet':
                        ...
                        if r:
                            domain =  [('betscore_id.betscore1', '=',r.predict_score1 ),('betscore_id.betscore2', '=',r.predict_score2),('match_id','=',match_id.id)]
                        else:
                            domain =  [('betscore_id.betscore1', '=',last_score1 ),('betscore_id.betscore2', '=', last_score2),('match_id','=',match_id.id)]
                        bet_score_id = match_id.env['tsbd.betscoreline'].search(domain)
                        if bet_score_id:
                            ti_le_money = bet_score_id.odd
                        else:
                            ti_le_money = 9.99
            else:
                if mode=='bet':
